...
export class EvidenceMap {
    ...
    static "__#8@#geoJsonCache": Map<string, Promise<any>>;
    /**
     ...
     */
    addArea(item: object, name: string, feature: object, areaOptions: object, selectedAreaOptions: object, onclick: Function, setInput: Function, unsetInput: Function, link?: string | undefined, ignoreZoom: any): import('leaflet').Layer;
    ...
    handleFillColor(item: any, value: any, values: any, colorPalette: any, colorScale: any, theme: any): any;
     ...
     */
    initializeData(data: unknown, { coordinates, value, checkInputs, min, max, colorPalette, legendType, valueFmt, chartType, legendId, legend, theme, sizeCol }: {
        theme: any;
    }): Promise<{
        values: any;
        colorPalette: any;
