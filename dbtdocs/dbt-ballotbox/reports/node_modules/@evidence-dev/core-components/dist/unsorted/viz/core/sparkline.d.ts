 ...
 */
export function getSparklineConfig(sparklineData: any, type: any, seriesType: string, color: string, yScale: any, value_format_object: any, date_format_object: any, height: any, theme: any): import("echarts").EChartsOption;
