...
with dbt_internal_unit_test_actual as (
  select
    "id","first_name","last_name","age","gender","state","party","email","registered_date","last_voted_date","age_group","voted_gen24","is_active", 'actual' as "actual_or_expected"
  from (
    with
...
dbt_internal_unit_test_expected as (
  select
    "id", "first_name", "last_name", "age", "gender", "state", "party", "email", "registered_date", "last_voted_date", "age_group", "voted_gen24", "is_active", 'expected' as "actual_or_expected"
  from (
    select 
 ...
 as "last_voted_date", 
    ...
    cast('30-49' as character varying(256))
 as "age_group", 
